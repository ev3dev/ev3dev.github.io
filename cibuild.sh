...
ruby publish.rb --no-fix-links --test 'htmlproof ./ --href-ignore /.*example\.com.*/,/https:\/\/github\.com\/myuser\/myrepo/,/.*revolds-whitepaper\.pdf/,/https:\/\/github.com\/ev3dev\/ev3dev\.github\.io\/edit\/.*/ --check-html --ignore-script-embeds --allow-hash-href'
