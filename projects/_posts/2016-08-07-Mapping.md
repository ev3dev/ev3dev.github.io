...
youtube_video_id: zqzevoKpPjQ # The video ID of the YouTube video to be displayed with this post
...
I keep at least building and running instructions on github.
</div>
...
**_You can rotate, move and zoom with the mouse._**
...
One way to share [x3d] content on the web is using [x3dom] which is [Web3d] standard.
...
[x3dom] - open-source framework for 3D graphics on the Web.
