...
<a data-download-button-platform="ev3"  class="btn-group-lg"><span class="glyphicon glyphicon-download-alt"></span> Download for LEGO MINDSTORMS EV3</a>
<br/><br/>
<h2 class="centered-light-heading"> Other platforms </h2>
<a data-download-button-platform="rpi" class="btn-group-md stacked-download-button">Raspberry Pi Model Zero/1</a>
<a data-download-button-platform="rpi2" class="btn-group-md stacked-download-button">Raspberry Pi Model 2/3</a>
<a data-download-button-platform="bone" class="btn-group-md stacked-download-button">BeagleBone</a>
</div>
