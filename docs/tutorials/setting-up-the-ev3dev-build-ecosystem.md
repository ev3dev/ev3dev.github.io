# Setting Up The `ev3dev` Build Ecosystem
...
First we need to try building the kernel. I keep the ev3dev-kernel
...
To actually populate and update the local mirrors, we've got an additional helper
